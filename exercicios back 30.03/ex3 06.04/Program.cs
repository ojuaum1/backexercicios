...
// processamento
int sim = 0, nao = 0, mulheresSim = 0, mulheresNao=0, totalMulheres=0, homensNao = 0, homensSim= 0, totalHomens = 0;
char sexo, resposta;
...
for (int i = 1; i <= 10; i++)
{
    ...
    Console.Write("A pessoa gostou do produto? (S)sim (N)nao: ");
...
Console.WriteLine($"porcentagem de homens que responderam nao +{porcentagem}%");
